...
cart.forEach((cartItem) => {
    ...
    if (deliveryOptionId === undefined) {
        console.error(`Delivery option ID is undefined for cart item with product ID ${productId}`);
        return;
    }
    ...
    const itemDeliveryDate = dayjs();
    const deliveryDate = itemDeliveryDate.add(deliveryOption.deliveryDays, 'days');
